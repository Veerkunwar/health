...
export const doctorDetailStyles = {
  // Layout styles
  pageContainer: "min-h- font-serif bg-linear-to-br from-blue-50 via-white to-blue-50 p-4 sm:p-6",
...
export const dashboardStyles = {
  // Layout styles
  pageContainer: "min-h-screen font-serif p-4 sm:p-6 bg-linear-to-br from-blue-50 via-blue-100 to-white",
  ...
  statCard: "p-4 rounded-full bg-linear-to-br from-blue-100 to-blue-50 shadow-sm border border-blue-100",
  ...
  searchIcon: "absolute left-3 top-2.5 w-5 h-5 text-blue-500",
  clearButton: "px-3 py-2 bg-blue-500 text-white rounded-full shadow hover:bg-blue-600",
  ...
  verticalLine: "w-1 h-12 rounded-md mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-linear-to-b from-blue-400 to-blue-200",
...
export const addServiceStyles = {
  // Container styles
  container: {
    main: "min-h-screen font-serif bg-linear-to-br from-blue-50 via-blue-100 to-sky-50 relative flex items-center justify-center p-4 sm:p-6 overflow-x-hidden",
  ...
  // Header styles
  header: {
    title: "text-2xl sm:text-3xl font-extrabold text-transparent bg-linear-to-r from-blue-700 to-sky-600 bg-clip-text",
  ...
  buttons: {
    ...
    submit: "inline-flex justify-center items-center gap-2 w-full sm:w-auto px-5 py-2 rounded-full bg-linear-to-r from-blue-500 to-sky-500 text-white font-medium hover:shadow-lg transition-all duration-200 disabled:opacity-60",
    ...
    addSlot: "w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-full bg-linear-to-r from-blue-500 to-sky-500 text-white font-medium hover:shadow-lg transition-all duration-200",
    ...
    container: (hasError) => 
      `w-full rounded-2xl p-4 ${
        hasError 
          ...
          : "bg-linear-to-b from-blue-50 to-sky-50 border border-blue-100"
  ...
  slots: {
    ...
    slotItem: "flex items-center gap-2 bg-linear-to-r from-blue-50 to-sky-50 border border-blue-100 px-2 py-2 my-1 rounded-full shadow hover:shadow-md transition-shadow min-w-0",
  ...
  toast: {
    ...
    toastSuccess: "bg-linear-to-r from-blue-50 to-sky-50 border-blue-100",
    iconContainer: (type) => {
      const styles = {
        error: "bg-linear-to-r from-red-100 to-orange-100 text-red-600",
        info: "bg-linear-to-r from-blue-100 to-cyan-100 text-blue-600",
        success: "bg-linear-to-r from-blue-100 to-sky-100 text-blue-600"
      };
...
export const serviceAppointmentsStyles = {
  ...
  rescheduleDateInput: "text-sm px-3 py-1 w-full sm:w-auto text-blue-800 border border-blue-500 rounded-full",
  rescheduleTimeInput: "text-sm px-3 py-1 w-full sm:w-auto text-blue-800 border border-blue-500 rounded-full",
  rescheduleActions: "flex gap-2 w-full sm:w-auto",
  rescheduleSaveButton: "flex-1 sm:flex-none px-3 py-1 bg-blue-500 cursor-pointer text-white border-blue-500 rounded-full text-sm",
...
export const serviceDashboardStyles = {
  // Container styles
  container: "min-h-screen font-serif p-4 sm:p-6 bg-linear-to-b from-blue-50 via-blue-25 to-white",
  ...
  statCard: {
    container: "rounded-full bg-linear-to-br from-blue-100 to-blue-50 shadow-sm border border-blue-100 p-4 gap-4 flex items-center",
