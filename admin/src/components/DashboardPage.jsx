...
import { BadgeIndianRupee, CalendarRange, CheckCircle, Search, User, UserRoundCheck, XCircle } from "lucide-react";
            ...
            <table className={s.table}>
              <thead className={s.tableHead}>
                <tr>
                  ...
                  <th className={s.tableHeaderCell}>Cancelled</th>
    ...
    <div className={s.mobileDoctorCard}>
      ...
      <div className={s.mobileStatsGrid}>
        ...
        <div>
          ...
          <div className={s.mobileStatValue + " " + s.textblue600}>{d.appointments.completed}</div>
        </div>
