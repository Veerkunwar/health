...
//it will normilize any date-like string
...
//this function will normilize schedule map: ex-'YYYY-MM-DD : [slot1, slot2...]
...
//that is nearrest date comes first
...
const ListPage = () => {
  ...
  //shoe doctors according to the filter
