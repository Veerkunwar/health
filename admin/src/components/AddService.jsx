...
const AddService = ({ serviceId }) => {
  ...
  const [removeImage, setRemoveImage] = useState(false); // remove the existing one
  ...
  //to fetch services when in the editing state
  useEffect(() => {
    let mounted = true;
  ...
  function handleImageChange(e) {
    ...
    //remove the exising image if user chooses a new file.
    setRemoveImage(false);
    setHasExistingImage(false);
  }
  ...
  //prevents the user for selecting the past time for that particular date
  ...
  // to validate that all filds are filled by user or not
  function validate() {
    const newErrors = {};
  ...
  //submit function create or update
