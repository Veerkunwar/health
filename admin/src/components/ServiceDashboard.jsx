...
const ServiceDashboard = ({ services: servicesProp = null }) => {
  ...
  }, []); // global helper to refresh the page and fetch the services
  ...
  return (
    <div className={serviceAppointmentsStyles.container}>
      <div className={serviceAppointmentsStyles.innerContainer}>
        {/* Header */}
          ...
          <div className={serviceDashboardStyles.table.body}>
            {loading ? (
              ...
              visibleServices.map((s) => {
                ...
                return(
                  <div className={serviceDashboardStyles.table.row}>
                    {/* for tablet */}
                     <div className={serviceDashboardStyles.table.tabletView}>
                        ...
                        <div
                          className={`${serviceDashboardStyles.table.tabletCell} text-blue-700`}
                        >
                          {s.completed}
                        </div>
                        <div
