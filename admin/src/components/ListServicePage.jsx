...
export default function ListServicePage() {
  ...
  //sort the slots as lastest come up first
  ...
  //to convert the array of slots into slot objects
  ...
  //convert map-like slots to array of object
  ...
  //to edit any services we save them for a particular service
                  ...
                  <div className={s.viewSection}>
                    ...
                    <div className={s.viewActions}>
                      ...
                      >
                        ...
                        <span className={s.textblue700}>Edit</span>
                      </button>
