      ...
      <div className={footerStyles.mainContent}>
        <div className={footerStyles.gridContainer}>
          <div className={footerStyles.companySection}>
            ...
            <p className={footerStyles.companyDescription}>
              ...
              providing exceptional medical care with cutting-edge technnology
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>+91 9140569267</span>
              </div>
          ...
          <div className={footerStyles.linksSection}>
            ...
            <ul className={footerStyles.linksList}>
              {quickLinks.map((link, index) => (
                <li key={link.href} className={footerStyles.linkItem}>
                  <a
                    href={link.href}
        ...
        <div className={footerStyles.bottomSection}>
          ...
          <div className={footerStyles.designerText}>
            ...
            <a className={footerStyles.designerLink}>
              Veer Kunwar Singh
            </a>
          </div>
        </div>
