...
// helper functions
// this function will convert timev 12hrs to number of minut since midnight;
// it will return the AM : PM
...
// this function accepet the obj or JSON string
    ...
    try {
        ...
        if (existing.imagePublicId) {
          try {
            ...
            console.warn("DeleteFromCloudunary warning:", e?.message || e);
          }
        }
